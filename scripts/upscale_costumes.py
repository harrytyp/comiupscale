...
def main():
    ...
    parser.add_argument('--src', default='Z:/Projekte/COMI-Upscaled/CMI UPSCALED/extracted/COMI/costumes')
    parser.add_argument('--dst', default='Z:/Projekte/COMI-Upscaled/CMI UPSCALED/upscaled/costumes')
    parser.add_argument('--esrgan', default='Z:/Projekte/COMI-Upscaled/tools/realesrgan-ncnn-vulkan-v0.2.0-windows/realesrgan-ncnn-vulkan.exe')
    parser.add_argument('--models', default='Z:/Projekte/COMI-Upscaled/tools/realesrgan-ncnn-vulkan-v0.2.0-windows/models')
