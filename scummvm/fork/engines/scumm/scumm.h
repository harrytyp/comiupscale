...
public:
	...
	/** HD asset manager (for upscaled external textures) */
	HDAssetManager *_hdAssetManager = nullptr;
	HdObjectManager *_hdObjectManager = nullptr;
	...
	int _hdLastScriptObj = 0; // last o8_drawObject call (for debug)
	int _hdLastScriptX = 0;
	int _hdLastScriptY = 0;
	int _hdLastScriptState = 0;
